...
def load() -> Config:
    ...
    return Config(
        ...
        planner_model=os.getenv("PLANNER_MODEL", "gemma2:2b"),
        evaluator_model=os.getenv("EVALUATOR_MODEL", os.getenv("LLM_MODEL", "gemma2:2b")),
        ...
        executor_timeout_seconds=float(os.getenv("EXECUTOR_TIMEOUT_SECONDS", os.getenv("PROVIDER_TIMEOUT_SECONDS", "30"))),
